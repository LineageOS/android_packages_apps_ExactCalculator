...
class CalculatorExpr {
    ...
    boolean hasTrailingConstant() {
        ...
        if (!(t instanceof Operator o)) return false;
    ...
    private boolean isPercent(int pos) {
        ...
        if (!(mExpr.get(pos + 2) instanceof Operator op)) {
            return false;
        }
    ...
    private int trailingBinaryOpsStart() {
        ...
        while (result > 0) {
            ...
            if (!(last instanceof Operator o)) break;
